...
| Phase 3 专业 | 🔄 实施中（2026-07-30 启动，3.1b+3.1c+3.1d+3.1e+3.2b+3.2c+3.3b+3.3c+3.3d+3.4b+3.4c+3.5c(部分) 已完成，见 `dev-docs/stages/phase-3.md` v2.7） | ST-GCN+BC + 多犬 + 3D + FCI-IGP + Jetson + 用户权限 |
